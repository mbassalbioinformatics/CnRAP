...
- **18/08/21 Update -**
Ok soooo in developing our ChIP-Seq Analysis Pipeline (ChIP-AP) (https://github.com/JSuryatenggara/ChIP-AP), a number of people have asked about Cut&Run and its use with that suite of tools. So keeping this interest in mind, we are developing **CARAS** (**C**ut **A**nd **R**un **A**nalysis **S**uite) which takes many design elements from ChIP-AP and tailors the analysis experience for C&R; **greatly** improving the experience over CnRAP. The code in this repo will remain as is (with only bug fixes being made) owing to its use in our [publication](https://www.cell.com/cell-reports/pdf/S2211-1247(20)31563-1.pdf) and a companion [STAR Protocol](https://www.sciencedirect.com/science/article/pii/S2666166721004573). However, when CARAS is ready, I will link it here! For now, were planning for a public release around Q4, 2021!! Those with C&R datasets looking to be involved in our analysis and development reachout!! We'd love the feedback and ideas on what to incorporate into the suite to make it as suitable as possible for the wider community.
